...
export const reservaCita = async function (req, res) {
  ...
  await pool.query(
    ...
    [ClienteID, 1, servicioSolicitado, horaCita, date, 0]
  );
  res.send("exitoso");
};
